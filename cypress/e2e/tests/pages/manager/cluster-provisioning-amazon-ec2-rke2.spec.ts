...
describe('Provision Node driver RKE2 cluster', { testIsolation: 'off', tags: ['@debug', '@manager', '@adminUser', '@standardUser', '@jenkins'] }, () => {
  ...
  it('can create a rke2 cluster with Amazon cloud provider', function() {
