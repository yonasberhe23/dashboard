...
describe('Provision Node driver RKE1 cluster with Azure', { testIsolation: 'off', tags: ['@debug', '@manager', '@adminUser', '@standardUser', '@jenkins'] }, () => {
  ...
  it('can create an azure rke1 cluster with Azure cloud provider', function() {
