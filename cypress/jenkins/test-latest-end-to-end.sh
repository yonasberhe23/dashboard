...
# Simulates the full flow for community latest (staging)
# Usage: ./test-latest-end-to-end.sh v2.13

export RANCHER_IMAGE_TAG="${1:-v2.13}"
export RANCHER_HELM_REPO="rancher-com-rc"
export WORKSPACE="/tmp/test-workspace"

echo "=========================================="
echo "End-to-End Test: community latest (staging)"
...
# Simulate init.sh logic for community latest (default case)
echo ""
echo "=== Step 2: Simulating init.sh (community latest case) ==="
...
CORRAL_rancher_chart_repo="latest"  # RANCHER_CHART_REPO_FOR_CORRAL mapping
...
# Community repos use RANCHER_IMAGE_TAG as-is (including head)
